...
const userSchema = require("../../database/ticketclient");
        ...
        switch (customId) {
                  ...
                  components: [
                    new ActionRowBuilder().addComponents(
                      new ButtonBuilder()
                        ...
                        .setLabel("Claim")
                        .setEmoji("<:supporter:1216737645938610227>")
                        .setStyle(ButtonStyle.Success),
                      new ButtonBuilder()
                        .setCustomId("closeTicket")
                        .setLabel("Close")
                        .setEmoji("<:beban_cross:1216737638036537427>")
                        .setStyle(ButtonStyle.Success)
                    ),
                  ],
                });
          ...
          case "closeTicket":
            ...
            if (usersData.closed === true)
              return await interaction.reply({
                embeds: [
                  new EmbedBuilder().setDescription("The ticket is already closed.").setColor(config.embed.errcolor)
                ]
              });
            ...
            if (!usersData.closer == member.id)
              return await interaction.reply({
                embeds: [
                  new EmbedBuilder().setDescription("You are not the user that closed this ticket!").setColor(config.embed.errcolor)
                ],
                ephemeral: true,
              });
            ...
            await interaction.reply({
              embeds: [
                new EmbedBuilder()
                  ...
                  .setFooter({
                    text: `${client.user.tag} Powered by Beban Server`,
          ...
          case "reopenTicket":
            ...
            if (!uData.closed)
              return await interaction.reply({
                embeds: [
                  new EmbedBuilder().setDescription("The ticket is not closed.").setColor(config.embed.color)
                ]
              });
              ...
              .send({
                embeds: [
                  new EmbedBuilder()
                    ...
                    .setDescription(`Transcript: Fitur transcript masih dikembangkan`)
                    .addFields(
                      {
                        name: "Closer",
